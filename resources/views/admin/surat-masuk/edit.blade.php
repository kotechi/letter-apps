<x-layouts.app title="Edit Surat Masuk">
            ...
            <div class="border-b border-gray-200 pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="yth_nama_sekolah_tujuan" 
                               value="{{ old('yth_nama_sekolah_tujuan', $suratMasuk->yth_nama_sekolah_tujuan) }}"
                               placeholder="Contoh: Kepala Sekolah SMK Negeri 1 Jakarta"
                               class="w-full border border-blue-600 p-2 rounded">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700">Yth. Alamat Sekolah Tujuan</label>
                        <input type="text" name="yth_alamat_sekolah_tujuan" 
                               value="{{ old('yth_alamat_sekolah_tujuan', $suratMasuk->yth_alamat_sekolah_tujuan) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama_sekolah_tujuan" 
                               value="{{ old('nama_sekolah_tujuan', $suratMasuk->nama_sekolah_tujuan) }}"
    ...
    <script>
        ...
        function renderLampiran(lampiranData = null) {
        ...
        window.addEventListener('DOMContentLoaded', function() {
            if (existingLampiran && existingLampiran.length > 0) {
                // Ambil hanya lampiran pertama
                const lampiran = existingLampiran[0];
                const lampiranData = {
                ...
                renderLampiran(lampiranData);
            } else {
                // Jika tidak ada lampiran existing, render lampiran kosong
                renderLampiran();
            }
        });
    </script>
