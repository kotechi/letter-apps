<x-layouts.app title="Edit Ijasah">
    <div class="w-full ml-2 bg-white rounded-sm shadow-lg p-8">
        <h2 class="text-2xl font-bold text-blue-600 mb-6">Edit Data Ijasah</h2>
        ...
        <form action="{{ route('admin.ijasah.update', $ijasah->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" 
                       name="asal_sekolah" 
                       value="{{ old('asal_sekolah', $ijasah->asal_sekolah) }}" 
                       class="w-full border border-blue-600 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
                ...
                <input type="date" 
                       name="tanggal_masuk" 
                       value="{{ old('tanggal_masuk', $ijasah->tanggal_masuk) }}" 
                       class="w-full border border-blue-600 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <textarea name="keterangan" 
                          rows="4" 
                          class="w-full border border-blue-600 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Masukkan keterangan tambahan">{{ old('keterangan', $ijasah->keterangan) }}</textarea>
            </div>
